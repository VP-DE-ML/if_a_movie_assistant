...
samples_text, intents_labels, output_rows, unique_labels = train_main.load_training_data('../input/intents.json')
...
train_main.save_model(model, hist, tokenizer, unique_intents, sequence_maxlen, "movie_assistant_core_")



#test
text = "recommend me a crazy movie"
print(text)
